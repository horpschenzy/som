                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control d-none" id="reference" name="reference" placeholder="Payment reference" />
                                        </div> <br>

                                        <div class="form-group">
                                            <button id="give-access" class="form-control btn-primary d-none" type="submit"><span>Verify Payment</span></button>
                                        </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#give-access').on('click',function(){
                ...
                let url = "{{ route('admin.process-access',[],false) }}/" + currentUser + '/' + $('#reference').val();
