    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{route('profile')}}"><i class="mdi mdi-account-circle font-size-17 text-muted align-middle me-1"></i>{{ Auth::user()->name }} Profile</a>
                    <a class="dropdown-item" href="{{route('transaction')}}"><i class="mdi mdi-wallet font-size-17 text-muted align-middle me-1"></i> My Wallet</a>
