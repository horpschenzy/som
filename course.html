...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/img/course-grid.jpg);">
        <div class="container">
            <h2>Course Grid</h2>
            <p>A six-week intensive bible training program, where the word of God is taught extensively, SOM is where you will learn ministry basics and learn to fulfill your God given purpose.</p>
        </div>
    </div>
</div>
