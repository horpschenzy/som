...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-5 pt-100 pb-95" style="background-image:url(assets/img/contact-us.jpg);">
        <div class="container">
            <h2>Contact Us</h2>
...
<div class="contact-info-area bg-img pt-180 pb-140 default-overlay" style="background-image:url(assets/img/register.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-12">
                <div class="single-contact-info mb-30 text-center">
                    ...
                    <p>Piccadilly Suites, 3 Piccadilly Street, <br> By SAMSUNG Office Igbo-Efon Junction/Traffic Light, <br> Lekki-Epe Express Road, Lekki</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
                <div class="single-contact-info mb-30 text-center">
