...
<!-- <div class="choose-area bg-img pt-90" style="background-image:url(assets/img/.png);">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-12">
                <div class="about-img">
                    <img src="assets/img/banner/pcs.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
...
<!-- <div class="fun-fact-area bg-img default-overlay pt-130 pb-100" style="background-image:url(assets/img/womangraduating.jpg);">
    <div class="container">
